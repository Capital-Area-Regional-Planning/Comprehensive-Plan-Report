...
<br>
<br>
Note that historic population data is not included for municipalites that have changed type. For example, if a town became a city in 2010, then the population totals will show as NA prior to 2010.
